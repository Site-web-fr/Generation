...
const vehicles = [
  { id: 'sf90', name: 'Ferrari SF90 Stradale', daily: 3500, km: 200, brand: 'ferrari' },
  { id: 'huracan', name: 'Lamborghini Huracán EVO', daily: 2800, km: 250, brand: 'lamborghini' },
  { id: 'rolls', name: 'Rolls-Royce Ghost', daily: 2200, km: 300, brand: 'rolls' },
  { id: 'bentley', name: 'Bentley Continental GT', daily: 1800, km: 300, brand: 'bentley' },
  { id: 'porsche', name: 'Porsche 911 Turbo S', daily: 1500, km: 350, brand: 'porsche' },
  { id: 'range', name: 'Range Rover SV Autobiography', daily: 900, km: 400, brand: 'range' },
];
      ...
      <div className="tool-carousel">
        ...
        <div className="tool-vehicle-track">
          {vehicles.map((v) => (
            ...
            >
              <div className={`tool-vehicle-3d tool-vehicle-3d--${v.brand}`} />
